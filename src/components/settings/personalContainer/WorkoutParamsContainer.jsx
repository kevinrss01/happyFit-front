...
const WorkoutParamsContainer = ({ userData, onChangeInput }) => {
   return (
      <div className='params-workout-container'>
         ...
         <Select
            defaultValue={userData?.availableTimePerSessionInMinutes?.toString() || '60'}
            ...
            className='input'
         >
            <SelectItem value='15'>J'ai 15 minutes disponibles par séance</SelectItem>
            <SelectItem value='30'>J'ai 30 minutes disponibles par séance</SelectItem>
            <SelectItem value='45'>J'ai 45 minutes disponibles par séance</SelectItem>
            <SelectItem value='60'>J'ai 60 minutes disponibles par séance</SelectItem>
            <SelectItem value='90'>J'ai 90 minutes disponibles par séance</SelectItem>
         </Select>
      </div>
   )
}
