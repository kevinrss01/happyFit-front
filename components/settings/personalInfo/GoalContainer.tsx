...
import { GoalContainerProps } from "@/types/propsTypes";
          ...
          <TabPanel>
            <Flex>
              <Bold className="text-white text-center">
                ...
                en meilleure santé, de vous sentir mieux physiquement et
                mentalement.
              </Bold>
              <Button
