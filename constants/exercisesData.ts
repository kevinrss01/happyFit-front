import { ExercisesDataList } from "@/types/programTypes";

export const exercisesDataList: ExercisesDataList = {
  training: {
    workout: [
      {
        name: "Squat",
        traduction: "Squat",
        description:
          "Le squat est un exercice de renforcement musculaire qui cible les quadriceps, les fessiers, les ischio-jambiers et les muscles du dos. Il reproduit le mouvement de l'accroupissement.",
        execution:
      ...
      {
        name: "Squat sumo",
        traduction: "Sumo Squat",
        description:
          "Le Squat sumo est un excellent exercice pour travailler les cuisses, les fessiers et les hanches. Sa particularité est la position large des pieds, inspirée du sumo.",
        execution:
      ...
      },
      {
        ...
        traduction: "Bench Press",
        description:
          "Le développé couché est un exercice de musculation poly-articulaire pour les pectoraux, triceps et deltoïdes antérieurs.",
        execution:
      ...
      },
      {
        ...
        traduction: "Deadlift",
        description:
          "Le soulevé de terre est un exercice de musculation qui engage les muscles globaux du corps, comprenant principalement le bas du dos, les fessiers et les ischio-jambiers.",
        execution:
      ...
      },
      {
        ...
        traduction: "Dumbbell Lunges",
        description:
          "C'est un exercice de musculation qui cible principalement les quadriceps, les fessiers et les ischio-jambiers. Il améliore également l'équilibre et la coordination.",
        execution:
      ...
      },
      {
        ...
        traduction: "Bulgarian Split Squats",
        description:
          "Il s'agit d'un exercice de force du bas du corps travaillant principalement vos quadriceps, hanches et fessiers. Il requiert une stabilité du tronc et une coordination",
        execution:
      ...
      {
        name: "Rowing barre",
        traduction: "Barbell row",
        description:
          "Exercise de musculation qui cible les muscles du dos en particulier le grand dorsal et le trapèze.",
        execution:
      ...
      },
      {
        ...
        muscleGroups: {
          english: {
            primaryMuscleGroups: "quadriceps,gluteus",
            secondaryMuscleGroups: "hamstring,calfs",
          },
          french: {
            primaryMuscleGroups: "Quadriceps, Fessiers",
      ...
      },
      {
        ...
        traduction: "Dumbbell Biceps Curl",
        description:
          "L'exercice du curl biceps avec haltères isole et développe le biceps brachial, qui est le muscle sur le devant du bras. ",
        execution:
      ...
      },
      {
        ...
        traduction: "Dumbbell fly",
        description:
          "L'écarté avec haltères est un exercice de bodybuilding qui cible principalement les muscles du torse, plus précisément les pectoraux. Il nécessite deux haltères.",
        execution:
      ...
      },
      {
        ...
        traduction: "Dumbbell lateral raise",
        description:
          "Un exercice de musculation spécifiquement pour les épaules. Il vise principalement le deltoïde latéral, offrant une épaule plus large et ronde.",
        execution:
      ...
      {
        name: "Leg curl assis",
        traduction: "Seated leg curl",
        description:
          "Le 'Leg curl assis' est un exercice de musculation spécifique pour les ischios-jambiers. Il développe la force et la masse musculaire à l'arrière des cuisses.",
        execution:
      ...
      },
      {
        ...
        traduction: "Low cable row",
        description:
          "Cet exercice vise principalement les muscles du dos, spécifiquement les muscles dorsaux larges, et aide à améliorer la posture et la stabilité.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Frowing-barre.gif?alt=media&token=d6cc8f13-9aa3-40fe-a0b6-d8906404eba5",
        muscleGroups: {
          english: {
            primaryMuscleGroups: "back,latissimus",
            secondaryMuscleGroups: "biceps,shoulders_back",
      ...
      {
        name: "Curl marteau",
        traduction: "Hammer Curl",
        description:
          "Un exercice de musculation qui cible les biceps et l'avant-bras, utilisant un mouvement de 'marteau' avec des haltères.",
        execution:
      ...
      },
      {
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Frussian-twist.gif?alt=media&token=abbc9b44-06a6-4830-a05e-a35a637e90e9",
        muscleGroups: {
          english: {
      ...
      },
      {
        ...
        muscleGroups: {
          english: {
            primaryMuscleGroups: "all_lower,all_upper",
      ...
      },
      {
        ...
        traduction: "Mountain Climber",
        description:
          "Un exercice de cardio full body qui renforce aussi bien vos bras, poitrine, quads, abdominaux, obliques et jambes. Il imite l'escalade en montagne.",
        execution:
      ...
      },
      {
        ...
        traduction: "Lunges",
        description:
          "Les fentes développent la force et la flexibilité des jambes et des fessiers. Elles travaillent aussi l'équilibre et la coordination.",
        execution:
      ...
      },
      {
        ...
        traduction: "Superman",
        description:
          "Exercice de musculation qui renforce les muscles du dos par l'extension de la colonne vertébrale, utile pour la posture et la prévention du mal de dos.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Fsuperman.gif?alt=media&token=a21fcd9b-1c84-4b88-b2f7-c16d35f58b9f",
        muscleGroups: {
          english: {
      ...
      {
        name: "Crunch à vélo",
        traduction: "Bicycle Crunches",
        description:
          "Il s'agit d'un exercice abdominal efficace qui vise les obliques ainsi que les muscles rectus abdominaux. C'est un excellent mouvement pour construire la force du noyau et améliorer l'endurance musculaire.",
        execution:
      ...
      },
      {
        ...
        traduction: "Side plank",
        description:
          "La planche latérale est un exercice de musculation qui cible les muscles obliques de l'abdomen. Il sollicite également l'équilibre et renforce le tronc.",
        execution:
      ...
      },
      {
        ...
        description:
          "Les pompes diamant sont une variation des pompes classiques qui ciblent plus spécifiquement les triceps, les pectoraux et les muscles des épaules.",
        execution:
      ...
      },
      {
        ...
        traduction: "Incline Push-ups",
        description:
          "Les Pompes inclinées ciblent les épaules, le haut des pectoraux et les triceps. C'est un mouvement de musculation utilisé pour construire et tonifier ces muscles.",
        execution:
      ...
      },
      {
        ...
        traduction: "Decline Push-ups",
        description:
          "Un exercice de musculation qui cible principalement les pectoraux supérieurs, les triceps et les deltoïdes antérieurs.",
        execution:
      ...
      },
      {
        ...
        traduction: "Fist Push-ups",
        description:
          "Exercice de musculation travaillant particulièrement les pectoraux, triceps et deltoïdes antérieurs. Permet d'augmenter la force de la partie supérieure du corps.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Fpushup-knuckle.gif?alt=media&token=0b60ec82-452b-4675-81a5-18fdeeab7734",
        muscleGroups: {
          english: {
            primaryMuscleGroups: "chest",
            secondaryMuscleGroups: "triceps,shoulders",
      ...
      },
      {
        ...
        traduction: "Chair",
        description:
          "La 'Chaise' est un exercice de gym pour les jambes & les fessiers. Il imite l'action de s'asseoir et se lever de une chaise. Excellent pour tonifier vos muscles du bas du corps.",
        execution:
      ...
      },
      {
        ...
        description:
          "C'est un exercice extrêmement efficace pour renforcer les abdominaux et améliorer l'équilibre, tout en aidant à la stabilisation du tronc.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2FHigh%20Knee%20Run.gif?alt=media&token=61dea7a4-e677-412f-8b42-b9ca6fb6ecd6",
        muscleGroups: {
          english: {
    ...
    cardio: [
      {
        ...
        traduction: "Treadmill or outdoor running",
        description:
          "C'est un exercice cardiovasculaire qui brûle des calories, renforce le cœur et améliore la santé respiratoire. Idéal pour perdre du poids et gagner en endurance.",
        execution:
      ...
      },
      {
        ...
        muscleGroups: {
          english: {
            primaryMuscleGroups: "quadriceps,hamstring,gluteus",
            secondaryMuscleGroups: "abs,back,core",
          },
          french: {
            primaryMuscleGroups:
              "Quadriceps, Ischios-jambiers, Fessiers, Mollets",
      ...
      {
        name: "Rameur",
        traduction: "Rowing Machine",
        description:
          "L'exercice du rameur est un exercice cardio qui sollicite de nombreux groupes musculaires. Il permet de tonifier le corps et d'améliorer l'endurance.",
        execution:
        ...
        muscleGroups: {
          ...
          french: {
            ...
            secondaryMuscleGroups:
              "Fessiers, Ischios-jambiers, Quadriceps, Épaules",
          },
        },
      },
      {
        name: "Escalier montant",
        traduction: "Ascending stairs",
        description:
          "Il s'agit de monter les escaliers de manière répétée pour tonifier les jambes et le cardio.",
        execution:
      ...
      {
        name: "Corde à sauter",
        traduction: "Jump rope",
        description:
          "La corde à sauter est un exercice cardio qui sollicite principalement les mollets, quadriceps et muscles abdominaux. Il aide à la coordination, l'équilibre et brûle beaucoup de calories.",
        execution:
        ...
        muscleGroups: {
          english: {
            primaryMuscleGroups: "quadriceps,hamstring,gluteus,abs",
      ...
      {
        name: "Pédalo",
        traduction: "Paddle Boat",
        description:
          "L'exercice 'Pédalo' est un entraînement d'abdominaux qui imite le mouvement de pédalage - excellent pour renforcer l'ensemble de votre core et améliorer votre endurance.",
        execution:
        ...
        muscleGroups: {
          ...
          french: {
            primaryMuscleGroups:
              "Quadriceps, Ischios-jambiers, Mollets, Fessiers",
            secondaryMuscleGroups: "Sangle abdominale, Abdominaux",
          },
        },
      },
      {
        name: "Jumping Jacks",
        traduction: "Jumping Jacks",
        description:
          "Un exercice cardio consistant à sauter tout en ouvrant et fermant bras et jambes. Parfait pour l'échauffement.",
        execution:
      ...
      },
      {
        ...
        description:
          "Mountain Climbers est un exercice de musculation qui sert à renforcer les muscles de l'ensemble du corps, travailler l'endurance musculaire et cardio-respiratoire, améliorer la mobilité, la coordination et l'équilibre.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Fmountain-climber.gif?alt=media&token=d7e3a0d8-d84f-4c2c-bd51-b9b229163192",
        muscleGroups: {
          english: {
            primaryMuscleGroups: "quadriceps,abs,shoulders",
            secondaryMuscleGroups: "back,gluteus,calfs",
          },
          french: {
            primaryMuscleGroups:
              "Quadriceps, Ischios-jambiers, Abdominaux, Épaules",
      ...
      },
      {
        ...
        traduction: "Spot running",
        description:
          "Un exercice cardio d'intérieur pour augmenter la fréquence cardiaque et brûler des calories. Très bien pour améliorer l'endurance.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2FrunOnPlace.gif?alt=media&token=127a4b1a-ea8b-4b75-8938-b2c04e8a56ba",
        muscleGroups: {
          english: {
            primaryMuscleGroups: "all_lower",
            secondaryMuscleGroups: "core,abs",
      ...
      {
        name: "Shadow Boxing",
        traduction: "Shadow Boxing",
        description:
          "Shadow Boxing is a workout routine that involves mimicking the movements of boxing without an opponent. It enhances speed, footwork, and punching technique.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2FShadow-Boxing-Workout.gif?alt=media&token=809e1a17-d567-40f5-b2d5-8c238498f391",
        muscleGroups: {
          english: {
      ...
      {
        name: "Fentes sautées",
        traduction: "Jumping Lunges",
        description:
          "Un exercice cardio intense visant les jambes et les fessiers, impliquant une fente statique suivie d'un saut en l'air.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Fjumping-lunges.gif?alt=media&token=3b8e18bd-c510-4219-9876-9808b7ccea0a",
        muscleGroups: {
          english: {
            primaryMuscleGroups: "quadriceps,gluteus",
            secondaryMuscleGroups: "hamstring,calfs,core",
          },
          french: {
            primaryMuscleGroups: "Quadriceps, Fessiers",
            secondaryMuscleGroups:
              "Ischios-jambiers, Mollets, Sangle abdominale",
          },
        },
      },
      {
        name: "Course en extérieur",
        traduction: "Outdoor running",
        description:
          "La course en extérieur est un exercice d'aérobie qui renforce le cœur, les poumons, et les muscles des jambes tout en brûlant des calories.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Frun.gif?alt=media&token=490a0566-b6cf-40e8-a577-4206201b9f2d",
        muscleGroups: {
          english: {
            primaryMuscleGroups: "all_lower",
            secondaryMuscleGroups: "core,abs",
      ...
      {
        name: "Squat sauté",
        traduction: "Jumping Squat",
        description:
          "Le squat sauté est un exercice de musculation qui cible principalement les quadriceps, les fessiers, et les mollets. Il améliore la force, l'endurance et la puissance explosive.",
        execution:
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Fjump-squat.gif?alt=media&token=20178ede-1c31-4013-8d0e-0c620355c8a3",
        muscleGroups: {
          english: {
            primaryMuscleGroups: "gluteus,quadriceps",
            secondaryMuscleGroups: "core,calfs",
      ...
      },
      {
        ...
        video: "",
        variant: null,
        gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Fburbee.gif?alt=media&token=173f346b-d45f-4460-b010-f196f3666272",
        muscleGroups: {
          english: {
            primaryMuscleGroups: "all_lower",
            secondaryMuscleGroups: "all_upper",
          },
          french: {
            primaryMuscleGroups: "Tous les muscles",
            secondaryMuscleGroups: "",
  ...
  warmUp: [
    ...
    {
      name: "Marche sur tapis roulant",
      traduction: "Treadmill Walking",
      description:
        "Un exercice cardiovasculaire simple et efficace. Idéal pour travailler l'endurance et brûler des calories.",
      execution:
      ...
      video: "",
      variant: null,
      gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Fincline-treadmill-walk.gif?alt=media&token=e3e6d168-24f4-4d8f-a82d-f0d021d98370",
      muscleGroups: {
        english: {
          primaryMuscleGroups: "all_lower",
          secondaryMuscleGroups: "core",
    ...
    {
      name: "Vélo elliptique (faible résistance)",
      traduction: "Elliptical bike (low resistance)",
      description:
        "Une activité cardio sur un vélo elliptique, réglé sur une faible résistance, pour débuter ou pour une récupération active. Bon pour l'endurance et la tonicité du bas du corps.",
      execution:
    ...
    },
    {
      ...
      traduction: "Jump rope",
      description:
        "Exercice d'endurance brûlant beaucoup de calories, renforce le cardio, la coordination et tonifie le corps en globalité.",
      execution:
      ...
      muscleGroups: {
        english: {
          primaryMuscleGroups: "calfs,quadriceps,hamstring,gluteus,core",
    ...
    },
    {
      ...
      traduction: "Squat",
      description:
        "Un exercice de musculation polyarticulaire qui cible principalement les jambes, les fesses et le noyau. Il renforce la force globale et améliore la flexibilité.",
      execution:
    ...
    },
    {
      ...
      traduction: "Butt kicks",
      description:
        "Exercise d'échauffement qui promeut la mobilité et la vitesse de vos jambes tout en renforçant vos fessiers.",
      execution:
      ...
      video: "",
      variant: null,
      gif: "https://firebasestorage.googleapis.com/v0/b/happyfit-app.appspot.com/o/workoutGif%2Fbut-kick.gif?alt=media&token=09a45423-2d15-460d-9523-996de0d49df4",
      muscleGroups: {
        english: {
    ...
    },
    {
      ...
      traduction: "Jumping jacks",
      description:
        "Exercice cardiovasculaire effectué en sautant avec les jambes écartées tout en déplaçant les bras au-dessus de la tête et en les faisant retomber. Idéal pour l'échauffement, brûle les graisses et renforce le coeur.",
      execution:
    ...
    },
    {
      ...
      traduction: "Push-ups",
      description:
        "Les pompes sont un exercice qui renforce et tonifie le haut du corps, ciblant les pectoraux, deltoïdes et triceps.",
      execution:
    ...
    },
    {
      ...
      traduction: "Jumping lunges",
      description:
        "Un exercice de bas du corps qui renforce et tonifie les cuisses et les fesses. Il implique un mouvement de saut entre les répétitions.",
      execution:
    ...
    },
    {
      ...
      traduction: "Military Plank",
      description:
        "Le gainage militaire renforce le corps en travaillant principalement les abdominaux, les obliques et le dos. Il améliore également l'endurance musculaire.",
      execution:
    ...
    {
      name: "Course sur place",
      traduction: "Running on the spot",
      description:
        "Il s'agit d'un exercice cardio qui stimule l'endurance et la perte de graisse, sans nécessité d'équipement ni de grand espace.",
      execution:
